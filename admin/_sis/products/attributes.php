...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span> Atributos
        </p>
    </div>
...
<div class="attr_modal modal_group">
    <div class="modal_area">
        ...
        <ul class="modal_area_tab">
            ...
            <li>
                <a class="wc_tab icon-image" href="#attr_group_print" title="Estampas">Linhas</a>
            </li>
        </ul>
        ...
        <form id="attr_group_size" class="modal_area_form wc_tab_target wc_active" name="form_attr_group_size" method="post" enctype="multipart/form-data">
            ...
            <div class="modal_area_form_wrapper">
                <label class="modal_area_form_wrapper_item" data-type="group">
                    <input type="text" name="group_title" placeholder="Tamanhos :: Espessuras"/>
        ...
        <form id="attr_group_color" class="modal_area_form wc_tab_target ds_none" name="form_attr_group_color" method="post" enctype="multipart/form-data">
            ...
            <div class="modal_area_form_wrapper">
                <label class="modal_area_form_wrapper_item" data-type="group">
                    <input type="text" name="group_title" placeholder="Cores :: Produtos"/>
        ...
        <form id="attr_group_print" class="modal_area_form wc_tab_target ds_none" name="form_attr_group_print" method="post" enctype="multipart/form-data">
            ...
            <div class="modal_area_form_wrapper">
                <label class="modal_area_form_wrapper_item" data-type="group">
                    <input type="text" name="group_title" placeholder="Linha :: Chapas"/>
...
<!--GROUP UPDATE -->
<div class="attr_modal modal_group_print_up">
    <div class="modal_area">
        <header>
            <h1>
                <i class="icon-make-group"></i> Atualizar Nome da Linha
            </h1>
        </header>

        <form id="attr_group_print" class="modal_area_form wc_tab_target " name="form_attr_group_print" method="post" enctype="multipart/form-data">
            <input type="hidden" name="callback" value="Products"/>
            <input type="hidden" name="callback_action" value="group_update"/>
        ...
        <div class="attr_modal_close j_close_modal" data-type-modal="modal_group_print_up">X</div>
    </div>
</div>

<div class="attr_modal modal_group_size_up">
    <div class="modal_area">
        <header>
            <h1>
                <i class="icon-make-group"></i> Atualizar Grupo Espessuras
            </h1>
        </header>
        <form id="attr_group_size" class="modal_area_form wc_tab_target wc_active" name="form_attr_group_size" method="post" enctype="multipart/form-data">
            <input type="hidden" name="callback" value="Products"/>
        ...
        <div class="attr_modal_close j_close_modal" data-type-modal="modal_group_size_up">X</div>
    </div>
</div>

<div class="attr_modal modal_group_color_up">
    <div class="modal_area">
        <header>
            <h1>
                <i class="icon-make-group"></i> Atualizar Grupo
            </h1>
        </header>
        ...
        <div class="attr_modal_close j_close_modal" data-type-modal="modal_group_color_up">X</div>
    </div>
</div>
<!--GROUP UPDATE -->
...
<!--MODAL print EDIT--><div class='attr_modal modal_attr_print_edit'></div><!--END MODAL print EDIT-->
<!--MODAL color EDIT--><div class='attr_modal modal_attr_color_edit'></div><!--END MODAL color EDIT-->
<!--MODAL size EDIT--><div class='attr_modal modal_attr_size_edit'></div><!--END MODAL size EDIT-->
    ...
    <?php
        ...
        if ($Read->getResult()):
            ...
            foreach ($Read->getResult() as $GROUP):
                ?>
                <div class="attr_group box box33 wc_draganddrop" callback="Products" callback_action="group_order" id="<?= $GROUP['group_id']; ?>">
                    ...
                    <div class="attr_group_actions">
                        ...
                        <span class="j_open_modal_group_name btn btn_blue icon-pen icon-notext" title="Editar Nome do Grupo" data-form="attr_group_<?= $GROUP['group_type']; ?>" data-type-modal="modal_group_<?= $GROUP['group_type']; ?>_up" data-group-title="<?= $GROUP['group_title']; ?>" data-group-id="<?= $GROUP['group_id']; ?>"></span>
                    ...
                    <div class="attr_group_body">
                        <div class="attr_group_scroll j_attr_item_target_<?= $GROUP['group_id']; ?>">
                            ...
                            <?php
                                ...
                                if ($Read->getResult()):
                                    //var_dump($Read->getResult());   $attr_print_id  $GROUP['group_type']
                                    ...
                                    foreach ($Read->getResult() as $ATTR):
                                        ...
                                        <div class="attr_group_item <?= "attr_{$GROUP['group_type']}_" . ($GROUP['group_type'] == 'size' ? $attr_size_id : ($GROUP['group_type'] == 'color' ? $attr_color_id : $attr_print_id)); ?>" id="<?= ($GROUP['group_type'] == 'size' ? $attr_size_id : ($GROUP['group_type'] == 'color' ? $attr_color_id : $attr_print_id)); ?>">
                                            ...
                                            <div<?= ($GROUP['group_type'] == 'color' ? " {$bg_color}" : ($GROUP['group_type'] == 'print' ? " {$bg_print}" : '')); ?> class='attr_group_item_code' title="<?= ($GROUP['group_type'] == 'size' ? $attr_size_title : ($GROUP['group_type'] == 'color' ? $attr_color_title : $attr_print_title)); ?>">
                                                ...
                                                <!--AQUI-->
                                                <span callback="Products" callback_action="attr_<?= ($GROUP['group_type'] == 'size' ? 'size' : ($GROUP['group_type'] == 'color' ? 'color' : 'print')); ?>" class="j_open_modal_edit attr_group_item_edit btn btn_blue icon-pen icon-notext" title="Editar Atributos" data-type-modal="modal_attr_<?= ($GROUP['group_type'] == 'size' ? 'size' : ($GROUP['group_type'] == 'color' ? 'color' : 'print')); ?>_edit" id="<?= ($GROUP['group_type'] == 'size' ? $attr_size_id : ($GROUP['group_type'] == 'color' ? $attr_color_id : $attr_print_id)); ?>"></span>
                                                <!--                                                EDIT-->
