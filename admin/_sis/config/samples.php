...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-embed2">Zen Control® Samples</h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; <?php echo ADMIN_NAME; ?>
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php">Dashboard</a>
            <span class="crumb">/</span>
        ...
        <div class="tab_contents">
            <div class="wc_tab_target wc_active" id="panels">
                <div class="box box50">
                    <div class="panel_header">
                        <span>
                            ...
                            <a href="javascript:void(0)" class="btn btn_blue icon-notext icon-embed2 wc_clip"
                               rel="panel_header_icon_action_subtitle"></a>
                        </span>
                        <h2><span class="icon-command">Título do Painel</span></h2>
                        <p class="subtitle">Subtítulo do Painel</p>
                    </div>
                    <div class="panel">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at
                            volutpat.
                            Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc
                            maximus magna et venenatis pellentesque.
                            Maecenas sollicitudin sit amet ligula et pulvinar. Vestibulum metus lacus, porta non orci
                            in, euismod semper quam.
                            Quisque tincidunt tortor non nibh sagittis porttitor. Ut justo lacus, mattis ut fringilla
                            ac, lacinia vel diam.</p>
                    </div>
                </div>
                ...
                <div class="box box50">
                    <div class="panel_header">
                        <span>
                            <a href="javascript:void(0)" class="btn btn_blue icon-notext icon-embed2 wc_clip"
                               rel="panel_header_icon_subtitle"></a>
                        </span>
                ...
                <div class="box box50">
                    <div class="panel_header">
                        <span>
                            <a href="javascript:void(0)" class="btn icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn btn_blue icon-notext icon-embed2 wc_clip"
                               rel="panel_header_action_subtitle"></a>
                        </span>
                ...
                <div class="box box100">
                    <div class="panel_header">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam scelerisque at enim at
                            ...
                            maximus magna et venenatis pellentesque.
                            Maecenas sollicitudin sit amet ligula et pulvinar.</p>
                        <p>Esse <i>parágrafo</i> possui um <u>elemento</u>
                            <mark>mark</mark>
                            com formatação padrão do CSS para <b>destaque!</b></p>
            ...
            <div class="wc_tab_target ds_none" id="boxes">
                ...
                <div class="box box100">
                    <div class="panel_header">
                        ...
                        <p class="subtitle">Para trabalhar com o sistema de box é bem simples! Basta que você crie uma
                            div e insira a class box + o tamanho da box que você deseja! Lembre-se que a soma do tamanho
                            das box's deve ser igual a 100! Logo se quiser um painel com 100% de largura crie uma div
                            com as classes box box100, ou se desejar ter dois painéis com 50% de largura cada um, crie
                            duas divs, cada uma delas com as classes box box50 respectivamente.</p>
                        <p class="subtitle"><strong>* Atenção:</strong> Somente a box33 a soma não é igual a 100, pois 3
                            box de 33,33% de largura é igual a 99,99% e esse 1% é descontado na margem.</p>
                    </div>
                </div>
                ...
                <div class="box box100">
                    <div class="panel_header">
                        ...
                        <p class="subtitle">O conceito da soma deve ser 100 assim como nas box uniformes, mas você tem a
                            possibilidade de mesclar diversos tamanhos de painéis para distribuir melhor o seu conteúdo
                            na tela do usuário. Veja os exemplos abaixo!</p>
                    </div>
                </div>
            ...
            <div class="wc_tab_target ds_none" id="forms">
                <div class="box box100">
                    ...
                    <div class="panel_header default">
                        <span>
                            <a href="javacript:void(0)" class="btn btn_blue icon-embed2 icon-notext wc_clip"
                               rel="form"></a>
                        </span>
                    ...
                    <div class="panel">
                        <form>
                            <label class="label">
                                ...
                                <input style="font-size: 1.4em;" type="text" name="titulo"
                            ...
                            <div class="label_50">
                                <label class="label">
                                    ...
                                    <input style="font-size: 1.4em;" type="text" name="campo1"
                                           placeholder="Digite um título" required/>
                                </label>
                                <label class="label">
                                    <span class="legend">Campo 2 50%:</span>
                                    <input style="font-size: 1.4em;" type="text" name="campo2"
                                           placeholder="Digite um título" required/>
                                </label>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="label_33">
                                ...
                                <label class="label">
                                    ...
                                    <input style="font-size: 1.4em;" type="text" name="campo3"
                                           placeholder="Digite um título" required/>
                                </label>
                            </div>
            ...
            <div class="wc_tab_target ds_none" id="buttons">
                <div class="box_content">
                    <p>Todas as variações abaixo podem ser aplicadas a elementos do tipo <b>&LT;a></b> ou
                        <b>&LT;button></b> adicionando obrigatoriamente a classe <b>.btn</b> e depois a variação.</p>
                    <p>Cores:</p>
                    ...
                    <a href="javascript:void(0)" class="btn btn_blue icon-calendar icon-notext rounded"></a> -
                    icon-calendar icon-notext rounded
                </div>
            </div>
            <!--CLOSE BUTTONS-->

            <div class="wc_tab_target ds_none" id="icons">
                <link rel="stylesheet" href="<?php echo BASE; ?>/_cdn/bootcss/icomoon/demo-files/demo.css"/>
                <div class="box box100">
                    <div class="panel_header default">
                        <h2 class="mhmm mvm"><span class="fgc1">Font Name:</span> icomoon <small class="fgc1">(Glyphs:&nbsp;491)</small>
                        </h2>
                    </div>
                    <div class="panel">
                        <div class="clearfix mhl ptl">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="folder-minus, directory4"
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="folder-download, directory5"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="folder-upload, directory6"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="phone-hang-up, telephone2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="volume-increase, volume6"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="volume-decrease, volume7"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-up-right, up-right"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-down-right, down-right"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-down-left, down-left"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-up-left2, up-left2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-up-right2, up-right2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-down-right2, down-right2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="arrow-down-left2, down-left2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="sort-alpha-desc, arrange2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="sort-numeric-asc, arrange3"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="sort-numberic-desc, arrange4"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="sort-amount-asc, arrange5"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="sort-amount-desc, arrange6"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="checkbox-checked, checkbox"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="checkbox-unchecked, checkbox2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="radio-checked, radio-button"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="radio-checked2, radio-button2"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="radio-unchecked, radio-button3"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="clear-formatting, wysiwyg17"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="insert-template, wysiwyg20"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                            ...
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="paragraph-left, wysiwyg25"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="paragraph-center, wysiwyg26"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="paragraph-right, wysiwyg27"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="paragraph-justify, wysiwyg28"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="indent-increase, wysiwyg29"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
                                ...
                                <div class="fs0 bshadow0 clearfix hidden-false">
                                    <span class="unit pvs fgc1">liga: </span>
                                    <input type="text" readonly value="indent-decrease, wysiwyg30"
                                           class="liga unitRight"/>
                                </div>
                            </div>
                            <div class="glyph fs1">
