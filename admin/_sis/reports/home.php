                    ...
                    <form name="class_add" action="" method="post" enctype="multipart/form-data">
                        ...
                        <label class="wc_ead_chart_range_picker">
                            <span>DE:</span><input readonly="readonly"
                                                   value="<?php echo \date('d/m/Y', \strtotime((string) $StartDate)); ?>"
                            ...
                            <span>ATÉ:</span><input readonly="readonly"
                                                    value="<?php echo \date('d/m/Y', \strtotime((string) $EndDate)); ?>"
            ...
            <div class="wc_ead_reports_boxes">
                <div class="box box33 wc_ead_reports_total">
                    <div class="box_content">
                        <p class="icon-users"><?php echo \str_pad((string) $viewUsers, 3, 0, 0); ?></p>
                        <span>Usuários Únicos</span>
                    </div>
                </div>
                <div class="box box33 wc_ead_reports_total">
                    <div class="box_content">
                        <p class="icon-stats-dots"><?php echo \str_pad((string) $viewViews, 3, 0, 0); ?></p>
                        <span>Visitas Únicas</span>
                    </div>
                </div>
                <div class="box box33 wc_ead_reports_total">
                    <div class="box_content">
                        <p class="icon-pie-chart"><?php echo $viewViews >= 1 ? \number_format(
        ...
        ?>
                        <article class="wc_ead_reports_single">
                            ...
                            <p class="row icon-users">
                                                                                <?php echo \str_pad((string) $AccessReport['viewUsers'], 3, 0, 0); ?> Usuários
                            </p>
                            <p class="row icon-stats-dots">
                                                                                <?php echo \str_pad((string) $AccessReport['viewViews'], 3, 0, 0); ?> Visitas
                            </p>
                            <p class="row icon-pie-chart">
                                                                                <?php echo $AccessReport['viewViews'] >= 1 ? \number_format(
