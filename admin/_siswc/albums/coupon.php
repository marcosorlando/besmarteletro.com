...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-ticket"><?php echo $cp_title ? $cp_title : 'Novo Cupom'; ?></h1>
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php?wc=products/coupons">Cupons</a>
            <span class="crumb">/</span>
            Gerenciar Desconto
        </p>
    </div>
        ...
        <div class="panel">
            <form class="auto_save" name="cupom_add" action="" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                    ...
                    <input style="font-size: 1.5em;" type="text" name="cp_title" value="<?php echo $cp_title; ?>"
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="text" name="cp_coupon" value="<?php echo $cp_coupon; ?>"
                               placeholder="Ex: Desconto de natal" required/>
                    </label>
                    ...
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="number" min="1" max="100" name="cp_discount"
                               value="<?php echo $cp_discount; ?>" placeholder="Ex: 20" required/>
                    </label>
                </div>
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="text" class="formTime" name="cp_start"
                               value="<?php echo \date('d/m/Y H:i', \strtotime((string) $cp_start)); ?>"
                    ...
                    <label class="label">
                        ...
                        <input style="font-size: 1.5em;" type="text" class="formTime" name="cp_end"
                               value="<?php echo \date('d/m/Y H:i', \strtotime((string) $cp_end)); ?>"
                               placeholder="dd/mm/yyyy hh:mm" required/>
                    </label>
                </div>
