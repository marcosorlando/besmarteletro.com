...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-bullhorn"><?php echo $hello_title ? $hello_title : 'Nova Hellobar'; ?></h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; <?php echo ADMIN_NAME; ?>
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php?wc=home">Dashboard</a>
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php?wc=hello/home">Hellobar</a>
            <span class="crumb">/</span>
            Gerenciar Hellobar
        </p>
    </div>
...
<div class="dashboard_content">
    ...
    <form name="hello_add" class="auto_save" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="hello_id" value="<?php echo $HelloId; ?>"/>

        <div class="box box70">
            <div class="panel">
                <label class="label">
                    <span class="legend">Capa (Largura de <?php echo IMAGE_W; ?>px):</span>
                    <input type="file" class="wc_loadimage" name="hello_cover"/>
                </label>

                <label class="label">
                    <span class="legend">Headline:</span>
                    <input class="font_large" type="text" name="hello_title" value="<?php echo $hello_title; ?>"
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <input type="text" name="hello_cta" value="<?php echo $hello_cta; ?>" placeholder="Texto do botão:"
                               required/>
                    </label>

                    <label class="label">
                        <span class="legend">Link:</span>
                        <input type="text" name="hello_link" value="<?php echo $hello_link; ?>" placeholder="Link de ação:"
                               required/>
                    </label>
                </div>
                ...
                <label class="label">
                    ...
                    <select name="hello_color" required="required">
                        ...
                        <option <?php echo 'blue' == $hello_color ? 'selected="selected"' : ''; ?> value="blue">Azul</option>
                        <option <?php echo 'green' == $hello_color ? 'selected="selected"' : ''; ?> value="green">Verde
                        </option>
                        <option <?php echo 'yellow' == $hello_color ? 'selected="selected"' : ''; ?> value="yellow">Amarelo
                        </option>
                        <option <?php echo 'red' == $hello_color ? 'selected="selected"' : ''; ?> value="red">Vermelho
                        </option>
                    </select>
                </label>
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <select name="hello_position" required="required">
                            ...
                            <option <?php echo 'center' == $hello_position ? 'selected="selected"' : ''; ?> value="center">Ao
                                centro da página!
                            </option>
                            <option <?php echo 'right_top' == $hello_position ? 'selected="selected"' : ''; ?>
                                    value="right_top">Direita Acima!
                            </option>
                            <option <?php echo 'right_bottom' == $hello_position ? 'selected="selected"' : ''; ?>
                    ...
                    <label class="label">
                        ...
                        <input type="text" name="hello_rule" value="<?php echo $hello_rule; ?>"
                ...
                <div class="label_50">
                    <label class="label">
                        ...
                        <input class="jwc_datepicker" data-timepicker="true" readonly="readonly" type="text"
                               name="hello_start" value="<?php echo empty($hello_start) ? \date('d/m/Y H:i') : \date(
                                   'd/m/Y H:i',
                    ...
                    <label class="label">
                        ...
                        <input class="jwc_datepicker" data-timepicker="true" readonly="readonly" type="text"
                               name="hello_end"
                               value="<?php echo empty($hello_end) ? \date('d/m/Y H:i', \strtotime('+10days')) : \date(
                                   'd/m/Y H:i',
...
?>
                <img style="width: 100%;" class="hello_cover" alt="Imagem da Hellobar" title="Imagem da Hellobar"
                     src="../tim.php?src=<?php echo $HelloImage; ?>&w=<?php echo IMAGE_W / 3; ?>&h=auto" default="../tim.php?src=<?php echo $HelloImage; ?>&w=<?php echo IMAGE_W / 3; ?>&h=auto"/>
            </div>
            <div class="panel">
                <div class="wc_actions">
                    <?php echo Check::switchOnOff('hello_status', $hello_status, 'Publicar:', 'SIM', 'NÃO'); ?>
