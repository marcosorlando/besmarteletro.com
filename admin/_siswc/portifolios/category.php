...
if (DB_AUTO_TRASH):
    $Delete = new Delete;
    $Delete->exeDelete(DB_CATEGORIES_PORTIFOLIO, "WHERE category_name IS NULL AND category_content IS NULL and porti_status = :st", "st=0");
...
if ($CatId):
    $Read->exeRead(DB_CATEGORIES_PORTIFOLIO, "WHERE category_id = :id", "id={$CatId}");
    if ($Read->getResult()):
         $FormData = \array_map(
        ...
        header('Location: dashboard.php?wc=portifolios/categories');
        exit;
    endif;
else:
    ...
    $Create->exeCreate(DB_CATEGORIES_PORTIFOLIO, $PostCreate);
    header('Location: dashboard.php?wc=portifolios/category&id=' . $Create->getResult());
    exit;
endif;
?>
...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="<?= ADMIN_NAME; ?>" href="dashboard.php?wc=portifolios/categories">Categorias</a>
            <span class="crumb">/</span>
            Gerenciar Categoria
        </p>
    </div>
    ...
    <div class="dashboard_header_search">
        <a title="Ver Categorias!" href="dashboard.php?wc=portifolios/categories" class="btn btn_blue icon-eye">Ver Categorias!</a>
            ...
            <form class="auto_save" name="category_add" action="" method="post" enctype="multipart/form-data">
                ...
                <label class="label">
                    ...
                    <select name="category_parent">
                        ...
                        <?php
                        $Read->fullRead("SELECT category_id, category_title FROM " . DB_CATEGORIES_PORTIFOLIO . " WHERE category_parent IS NULL AND category_id != :ci ORDER BY category_title ASC", "ci={$CatId}");
                        if ($Read->getResult()):
