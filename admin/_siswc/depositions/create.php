...
<header class="dashboard_header">
    <div class="dashboard_header_title">
        <h1 class="icon-pen"><?php echo $depositions_name ?? 'Novo Depoimento'; ?></h1>
        <p class="dashboard_header_breadcrumbs">
            &raquo; <?php echo ADMIN_NAME; ?>
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php?wc=home">Dashboard</a>
            <span class="crumb">/</span>
            <a title="<?php echo ADMIN_NAME; ?>" href="dashboard.php?wc=depositions/home">Depoimentos</a>
            <span class="crumb">/</span>
...
<div class="dashboard_content">
    <form name="deposition_create" class="auto_save" action="" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="depositions_id" value="<?php echo $DepositionId; ?>"/>
            ...
            <div class="box_content">
                <label class="label">
                    ...
                    <input class="font_large" type="text" name="depositions_name"
                           value="<?php echo $depositions_name; ?>" placeholder="Nome do Depoente:" required/>
                </label>
                <label class="label">
                    <span class="legend">Profissão do depoente:</span>
                    <input class="font_medium" type="text" name="depositions_profession"
                           value="<?php echo $depositions_profession; ?>" placeholder="Profissão do Depoente:" required/>
                </label>
                <label class="label">
                    <span class="legend">Depoimento:</span>
                    <textarea name="depositions_text" rows="6" required><?php echo $depositions_text; ?></textarea>
                </label>
...
?>
                <img class="depositions_image" src="../tim.php?src=<?php echo $Image; ?>&w=500&h=500"
                     default="../tim.php?src=<?php echo $Image; ?>&w=500&h=500">
                <div class="box_content">
                    <div class="m_top">&nbsp;</div>
