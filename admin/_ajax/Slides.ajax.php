    ...
    switch ($Case):
        ...
        case 'manager':
            ...
            elseif (in_array('', $PostData)):
                ...
                $PostData['show_complement'] = (!empty($PostData['show_complement']) ? $PostData['show_complement'] :
	                '0');
                $PostData['slide_category'] = (!empty($PostData['slide_category']) ? $PostData['slide_category'] : '0');
                $PostData['slide_product'] = (!empty($PostData['slide_product']) ? $PostData['slide_product'] : '0');
                ...
                if (!empty($imageMobile)):
                    ...
                    $Upload->Image($imageMobile, Check::Name($PostData['slide_name']) . '-' . 'mobile', SLIDE_W, 'slides');
                ...
                if (!empty($imageTablet)):
                    ...
                    $Upload = new Upload('../../uploads/');
                    $Upload->Image($imageTablet, Check::Name($PostData['slide_name']) . '-' . 'tablet', SLIDE_W, 'slides');
                ...
                if (!empty($imageDesktop)):
                    ...
                    $Upload = new Upload('../../uploads/');
                    $Upload->Image($imageDesktop, Check::Name($PostData['slide_name']) . '-' . 'desktop', SLIDE_W, 'slides');
