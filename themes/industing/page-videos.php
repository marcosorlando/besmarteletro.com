                ...
                <div class="display-table-cell vertical-align-middle breadcrumb text-small alt-font">
                    ...
                    <ul class="xs-text-center">
                        ...
                        <li>
                            ...
                            <div class="g-ytsubscribe" data-channelid="<?php echo SITE_SOCIAL_YOUTUBE; ?>"
...
<section class="parallax wow fadeIn" data-stellar-background-ratio="0.1"
         style="background:url('<?php echo INCLUDE_PATH; ?>/images/keuren-canedo-melhor-equipe-do-mundo1600.jpg');">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 text-center center-col">
                <a href="https://www.youtube.com/watch?v=4C9P00hug_8" class="popup-youtube"><img
                            src="<?php echo INCLUDE_PATH; ?>/images/icon-play.png" class="width-30" alt=""/></a>
        ...
        <div class="row">
            <div
                ...
                <div class="display-table-cell vertical-align-middle overflow-hidden position-relative">
                    ...
                    <img src="<?php echo INCLUDE_PATH; ?>/images/video-tia-marcela.jpg" class="width-100"
...
<section class="position-relative wow fadeIn">
    ...
    <video loop="" autoplay="" controls="" muted class="html-video" poster="http://placehold.it/1920x1280">
        ...
        <source type="video/webm" src="<?php echo BASE; ?>/uploads/video/video.webm">
    </video>
    <!-- end HTML5 video -->
</section>
