...
?>
<?php require REQUIRE_PATH. '/inc/slides.php'; ?>
        ...
        <div class="content">
            <header class="heading">
                <h1 class="text-center">
                    Encontre o
                    <span>Representante</span> mais próximo de você
                </h1>
            </header>


            <div class="box box2 m_zero_auto representatives">
                <form class="j_formsubmit" name="form_representatives" id="form_representatives" method="post" action="" enctype="multipart/form-data">
                    ...
                    <select style="display: none; margin-top: 30px" id='CITY' name='city' required class="callback_return_cities">

                    </select>
                    <figure class="form_spinner">
                        <img class="form_load none" src="<?= INCLUDE_PATH; ?>/images/load.gif"/>
                        <br>
            ...
            <div class="callback_return_rep representative box box2 m_zero_auto"></div>
            <br clear="all">
        </div>
    </div>
</section>
