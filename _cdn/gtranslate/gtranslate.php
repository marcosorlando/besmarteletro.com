...
<div class="absolute-flags">
   ...
   <!-- <a href="#" onclick="doGTranslate('pt|pt');return false;" title="Portuguese" class="gflag nturl">
    ...
    <a href="#" onclick="doGTranslate('pt|pt');return false;" title="Portuguese" class="gflag nturl">
        <img src="<?php echo BASE; ?>/_cdn/gtranslate/country-flags-main/svg/br.svg" alt="Portugues"/>
    </a>

    <a href="#" onclick="doGTranslate('pt|es');return false;" title="Spanish" class="gflag nturl">
        <img src="<?php echo BASE; ?>/_cdn/gtranslate/country-flags-main/svg/es.svg" alt="Espanhol"/>
    </a>

    <a href="#" onclick="doGTranslate('pt|ja');return false;" title="Japan" class="gflag nturl">
        <img src="<?php echo BASE; ?>/_cdn/gtranslate/country-flags-main/svg/jp.svg" alt="Japonês"/>
    </a>

    <a href="#" onclick="doGTranslate('pt|en');return false;" title="English" class="gflag nturl">
        <img src="<?php echo BASE; ?>/_cdn/gtranslate/country-flags-main/svg/sh.svg" alt="Inglês"/>
    </a>
</div>
<style> <!--  .absolute-flags {position: relative;width: 100%;align-items: center;text-align: right;margin-top: 5px;
        margin-right: 5px;z-index: 9999;}  a.gflag {color: #333333;vertical-align: middle;line-height: 20px;padding:
            0;text-decoration: none;}a .gflag span, a.gflag span:before{margin-right: 3px}  a.gflag img {border: 0;height: 20px;width: auto;box-shadow: -1px -1px 2px rgba(0, 0, 0, .1);opacity: 0.9;}  a.gflag img:hover {border: 0;box-shadow: 1px 1px 3px rgba(0, 0, 0, .2);opacity: 1;}  #goog-gt-tt {display: none !important;}  .goog-te-banner-frame {display: none !important;}  .goog-te-menu-value:hover {text-decoration: none !important;}  body {top: 0 !important;}  #google_translate_element2, .skiptranslate {display: none !important;}  --></style>
