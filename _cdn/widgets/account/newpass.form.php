<form name="account_form" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="account_form_actions">
        ...
        <img alt="Alterando Senha!" title="Alterando Senha!" src="<?php echo BASE; ?>/_cdn/widgets/account/load.gif"/>
        <div>&nbsp;</div>
        <a title="Voltar e Logar!" href="<?php echo $AccountBaseUI; ?>/login#acc">Voltar e Logar!</a>
    </div>
</form>