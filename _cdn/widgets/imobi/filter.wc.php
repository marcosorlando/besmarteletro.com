<link rel="stylesheet" href="<?php echo BASE; ?>/_cdn/widgets/imobi/filter.wc.css"/>
<script src="<?php echo BASE; ?>/_cdn/widgets/imobi/filter.wc.js"></script>
        ...
        <form class="wc_imobi_filter_form" name="wc_imobi_filter" action="" method="post" enctype="multipart/form-data">
            <select name="transaction">
                ...
                foreach (\getWcRealtyTransaction() as $TransId => $TransValue) {
                    echo \sprintf("<option value='%s'>%s</option>", $TransId, $TransValue);
                }
?>
            ...
            </select><a class="btn btn_green" href="<?php echo BASE; ?>/filtro" title="Filtrar Imóveis">BUSCAR!</a>
        </form>
        <div class="clear"></div>
    </div>
</article>