...
<script type="text/javascript">
    (function () {
        var options = {
            ...
            whatsapp: "<?php echo SITE_ADDR_WHATS_TRIM; ?>", // WhatsApp number
            email: "<?php echo SITE_ADDR_EMAIL; ?>", // Email
            company_logo_url: "<?php echo $favicon; ?>", // URL of company logo (png, jpg, gif)
